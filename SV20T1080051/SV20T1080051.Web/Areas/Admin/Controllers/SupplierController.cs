...
namespace SV20T1080051.Web.Areas.Admin.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        private const string SupplierSearch = "SupplierSearch";
        /// <summary>
        /// 
        /// </summary>
        ...
        public IActionResult Search(PaginationSearchInput input)
        {
            ...
            ApplicationContext.SetSessionData(SupplierSearch, model);
        ...
        public IActionResult Save(Supplier data)
        {
            ...
            if (string.IsNullOrWhiteSpace(data.SupplierName))
                ModelState.AddModelError(nameof(data.SupplierName), "Tên nhà cung cấp không được để rỗng");
            if (string.IsNullOrWhiteSpace(data.ContactName))
                ModelState.AddModelError(nameof(data.ContactName), "Tên giao dịch không được để rỗng");
